...
| `pvd-dashboard.html` | เครื่องมือเดี่ยว: วางแผนภาษีและกองทุนสำรองเลี้ยงชีพ (PVD) — คำนวณ % ที่ต้องหักจากค่าจ้างภายใต้เพดานกฎหมาย 15% และเตือนเพดานลดหย่อน 500,000 บาท/ปี — เปิดในเบราว์เซอร์ได้ทันที
